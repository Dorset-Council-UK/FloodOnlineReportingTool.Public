...
/// <summary>
/// Represents the one-to-many relationship between an eligibility check and cause flood problems.
/// </summary>
public record EligibilityCheckCause(Guid EligibilityCheckId, Guid FloodProblemId)
{
