...
internal static class InitialData
{
    ...
    internal static FloodImpact[] FloodImpactData()
    {
        return [
            // Property Type
            new FloodImpact(FloodImpactIds.Residential, FloodImpactCategory.PropertyType, "Residential", "Residential", FloodImpactPriority.None, 1),
            new FloodImpact(FloodImpactIds.Commercial, FloodImpactCategory.PropertyType, "Commercial", "Commercial", FloodImpactPriority.None, 2),
            new FloodImpact(FloodImpactIds.PropertyTypeOther, FloodImpactCategory.PropertyType, "Other", "Other", FloodImpactPriority.None, 3),
            new FloodImpact(FloodImpactIds.PropertyTypeNotSpecified, FloodImpactCategory.PropertyType, "Not Specified", "Not Specified", FloodImpactPriority.None, 99),

            // Priority
            new FloodImpact(FloodImpactIds.Building, "Priority", "Building", "Building", FloodImpactPriority.Internal, 1),
            new FloodImpact(FloodImpactIds.Grounds, "Priority", "Grounds", "Grounds", FloodImpactPriority.External, 2),
            new FloodImpact(FloodImpactIds.Both, "Priority", "Both", "Both", FloodImpactPriority.Both, 3),
            new FloodImpact(FloodImpactIds.Unknown, "Priority", "Unknown", "Unknown", FloodImpactPriority.Other, 4),
            new FloodImpact(FloodImpactIds.PriorityNotSpecified, "Priority", "Not Specified", "Not Specified", FloodImpactPriority.Other, 9),

            // Zone Residential
            new FloodImpact(FloodImpactIds.InsideLivingArea, FloodImpactCategory.Residential, "Inside living area", "Inside living area", FloodImpactPriority.Internal, 1),
            new FloodImpact(FloodImpactIds.MobileHomeCaravan, FloodImpactCategory.Residential, "Mobile Home / Caravan", "Mobile Home / Caravan", FloodImpactPriority.Internal, 2),
            new FloodImpact(FloodImpactIds.Basement, FloodImpactCategory.Residential, "Basement / Cellar", "Basement / Cellar", FloodImpactPriority.Internal, 3),
            new FloodImpact(FloodImpactIds.GarageAttached, FloodImpactCategory.Residential, "Garage attached to property", "Garage attached to property", FloodImpactPriority.Internal, 4),
            new FloodImpact(FloodImpactIds.ZoneRUnderFloorboards, FloodImpactCategory.Residential, "Under floorboards", "Under floorboards", FloodImpactPriority.Internal, 5),
            new FloodImpact(FloodImpactIds.ZoneRAgainstWall, FloodImpactCategory.Residential, "Against property wall", "Against property wall", FloodImpactPriority.External, 6),
            new FloodImpact(FloodImpactIds.PropertyAccess, FloodImpactCategory.Residential, "Property Access", "Property Access", FloodImpactPriority.External, 7),
            new FloodImpact(FloodImpactIds.ZoneROutbuilding, FloodImpactCategory.Residential, "Outbuilding(s)", "Outbuilding(s)", FloodImpactPriority.External, 8),
            new FloodImpact(FloodImpactIds.Garden, FloodImpactCategory.Residential, "Garden", "Garden", FloodImpactPriority.External, 9),
            new FloodImpact(FloodImpactIds.ZoneRRoad, FloodImpactCategory.Residential, "Road", "Road", FloodImpactPriority.External, 10),
            new FloodImpact(FloodImpactIds.ZoneRNotSure, FloodImpactCategory.Residential, "Not Sure", "Not Sure", FloodImpactPriority.Other, 99),
            // Zone Commercial
            new FloodImpact(FloodImpactIds.InsideBuilding, FloodImpactCategory.Commercial, "Inside building", "Inside building", FloodImpactPriority.Internal, 1),
            new FloodImpact(FloodImpactIds.BelowGroundLevelFloors, FloodImpactCategory.Commercial, "Below ground level floors", "Below ground level floors", FloodImpactPriority.Internal, 2),
            new FloodImpact(FloodImpactIds.ZoneCUnderFloorboards, FloodImpactCategory.Commercial, "Under floorboards", "Under floorboards", FloodImpactPriority.Internal, 3),
            new FloodImpact(FloodImpactIds.ZoneCAgainstWall, FloodImpactCategory.Commercial, "Against property wall", "Against property wall", FloodImpactPriority.External, 4),
            new FloodImpact(FloodImpactIds.ZoneCOutbuilding, FloodImpactCategory.Commercial, "Outbuilding(s)", "Outbuilding(s)", FloodImpactPriority.External, 5),
            new FloodImpact(FloodImpactIds.FieldsBusinessLand, FloodImpactCategory.Commercial, "Fields / Business Land", "Fields / Business Land", FloodImpactPriority.External, 6),
            new FloodImpact(FloodImpactIds.CarPark, FloodImpactCategory.Commercial, "Car Park", "Car Park", FloodImpactPriority.External, 7),
            new FloodImpact(FloodImpactIds.Access, FloodImpactCategory.Commercial, "Access", "Access", FloodImpactPriority.External, 8),
            new FloodImpact(FloodImpactIds.ZoneCRoad, FloodImpactCategory.Commercial, "Road", "Road", FloodImpactPriority.External, 9),
            new FloodImpact(FloodImpactIds.ZoneCNotSure, FloodImpactCategory.Commercial, "Not Sure", "Not Sure", FloodImpactPriority.Other, 99),

            // Service impacts / Zone-E
            new FloodImpact(FloodImpactIds.PrivateSewer, FloodImpactCategory.ServiceImpact, "Private sewer", "Private sewer", FloodImpactPriority.None, 2),
            new FloodImpact(FloodImpactIds.MainsSewer, FloodImpactCategory.ServiceImpact, "Mains sewer", "Mains sewer", FloodImpactPriority.None, 3),
            new FloodImpact(FloodImpactIds.WaterSupply, FloodImpactCategory.ServiceImpact, "Water supply", "Water supply", FloodImpactPriority.None, 4),
            new FloodImpact(FloodImpactIds.Gas, FloodImpactCategory.ServiceImpact, "Gas", "Gas", FloodImpactPriority.None, 5),
            new FloodImpact(FloodImpactIds.Electricity, FloodImpactCategory.ServiceImpact, "Electricity", "Electricity", FloodImpactPriority.None, 6),
            new FloodImpact(FloodImpactIds.Phoneline, FloodImpactCategory.ServiceImpact, "Phoneline", "Phoneline", FloodImpactPriority.None, 7),
            new FloodImpact(FloodImpactIds.ServicesNotAffected, FloodImpactCategory.ServiceImpact, "Services not affected", "Services not affected", FloodImpactPriority.None, 98),
            new FloodImpact(FloodImpactIds.ServiceImpactNotSure, FloodImpactCategory.ServiceImpact, "Not sure", "Not sure", FloodImpactPriority.None, 99),

            // Community Impact
            new FloodImpact(FloodImpactIds.AllRoadAccessBlocked, FloodImpactCategory.CommunityImpact, "All road access blocked", "All road access blocked", FloodImpactPriority.None, 1),
            new FloodImpact(FloodImpactIds.SomeRoadAccessBlocked, FloodImpactCategory.CommunityImpact, "Some road access blocked", "Some road access blocked", FloodImpactPriority.None, 2),
            new FloodImpact(FloodImpactIds.NoAccessToPlaceOfWork, FloodImpactCategory.CommunityImpact, "No access to place of work", "No access to place of work", FloodImpactPriority.None, 3),
            new FloodImpact(FloodImpactIds.PublicTransportDisrupted, FloodImpactCategory.CommunityImpact, "Public transport disrupted", "Public transport disrupted", FloodImpactPriority.None, 4),
            new FloodImpact(FloodImpactIds.LocalShopClosed, FloodImpactCategory.CommunityImpact, "Local shop(s) closed", "Local shop(s) closed", FloodImpactPriority.None, 5),
            new FloodImpact(FloodImpactIds.CommunityImpactNotSure, FloodImpactCategory.CommunityImpact, "Not Sure", "Not Sure", FloodImpactPriority.None, 99),

            // Impact Duration
            new FloodImpact(FloodImpactIds.UseNotDisrupted, "Impact Duration", "Use not disrupted", "Use not disrupted", FloodImpactPriority.None, 1),
            new FloodImpact(FloodImpactIds.UpToOneWeek, "Impact Duration", "Up to 1 week", "Up to 1 week", FloodImpactPriority.None, 2),
            new FloodImpact(FloodImpactIds.OneWeekToOneMonth, "Impact Duration", "1 week to 1 month", "1 week to 1 month", FloodImpactPriority.None, 3),
            new FloodImpact(FloodImpactIds.OneMonthToSixMonths, "Impact Duration", "1 month to 6 months", "1 month to 6 months", FloodImpactPriority.None, 4),
            new FloodImpact(FloodImpactIds.GreaterThanSixMonths, "Impact Duration", ">6 months", ">6 months", FloodImpactPriority.None, 5),
            new FloodImpact(FloodImpactIds.StillUnable, "Impact Duration", "Still unable", "Still unable", FloodImpactPriority.None, 6),
            new FloodImpact(FloodImpactIds.ImpactDurationNotSure, "Impact Duration", "Not Sure", "Not Sure", FloodImpactPriority.None, 99),
            // Import unknown - don't include in any forms but will be needed for displaying imported data with unknown values
            new FloodImpact(new("019f6a3a-f7eb-74ef-824d-5b673146160e"),"All", "Unknown", "Imported record with unknown value", FloodImpactPriority.None, 99),
        ];
    }
    ...
    internal static FloodMitigation[] FloodMitigationData()
    {
        return [
            // Action Taken
            new FloodMitigation(FloodMitigationIds.NoActionTaken, FloodMitigationCategory.ActionsTaken, "No Action Taken", "No Action Taken", 99),
            new FloodMitigation(FloodMitigationIds.Sandbags, FloodMitigationCategory.ActionsTaken, "Sandbags", "Sandbags", 2),
            new FloodMitigation(FloodMitigationIds.SandlessSandbag, FloodMitigationCategory.ActionsTaken, "Sandless Sandbag", "Sandless Sandbag", 3),
            new FloodMitigation(FloodMitigationIds.BoardsGate, FloodMitigationCategory.ActionsTaken, "Flood Boards / Gate", "Flood Boards / Gate", 4),
            new FloodMitigation(FloodMitigationIds.FloodDoor, FloodMitigationCategory.ActionsTaken, "Flood Door", "Flood Door", 5),
            new FloodMitigation(FloodMitigationIds.BackflowValve, FloodMitigationCategory.ActionsTaken, "Back-flow valve", "Back-flow valve", 6),
            new FloodMitigation(FloodMitigationIds.AirBrickCover, FloodMitigationCategory.ActionsTaken, "Air brick cover", "Air brick cover", 7),
            new FloodMitigation(FloodMitigationIds.PumpedWater, FloodMitigationCategory.ActionsTaken, "Pumped Water", "Pumped Water", 8),
            new FloodMitigation(FloodMitigationIds.MoveValuables, FloodMitigationCategory.ActionsTaken, "Move Valuables", "Move Valuables", 9),
            new FloodMitigation(FloodMitigationIds.MoveCar, FloodMitigationCategory.ActionsTaken, "Move Car", "Move Car", 10),
            new FloodMitigation(FloodMitigationIds.OtherAction, FloodMitigationCategory.ActionsTaken, "Other", "Other", 11),

            // Help Received From
            new FloodMitigation(FloodMitigationIds.NoHelp, FloodMitigationCategory.HelpReceived, "No Help", "No Help", 99),
            new FloodMitigation(FloodMitigationIds.NeighboursFamilyHelp, FloodMitigationCategory.HelpReceived, "Neighbours / Family", "Neighbours / Family", 2),
            new FloodMitigation(FloodMitigationIds.WardenVolunteerHelp, FloodMitigationCategory.HelpReceived, "Wardens / Volunteers", "Wardens / Volunteers", 3),
            new FloodMitigation(FloodMitigationIds.FirePolice, FloodMitigationCategory.HelpReceived, "Fire and Rescue / Police", "Fire and Rescue / Police", 4),
            new FloodMitigation(FloodMitigationIds.EnvironmentAgency, FloodMitigationCategory.HelpReceived, "Environment Agency", "Environment Agency", 5),
            new FloodMitigation(FloodMitigationIds.Highways, FloodMitigationCategory.HelpReceived, "Highways", "Highways", 6),
            new FloodMitigation(FloodMitigationIds.LocalAuthority, FloodMitigationCategory.HelpReceived, "Local Authority", "Local Authority", 7),
            new FloodMitigation(FloodMitigationIds.FloodlineHelp, FloodMitigationCategory.HelpReceived, "Floodline", "Floodline", 8),

            // Warning Source
            new FloodMitigation(FloodMitigationIds.NoWarning, FloodMitigationCategory.WarningSource, "I did not get a warning", "I did not get a warning", 99),
            new FloodMitigation(FloodMitigationIds.FloodlineWarning, FloodMitigationCategory.WarningSource, "Floodline", "Floodline", 2),
            new FloodMitigation(FloodMitigationIds.Television, FloodMitigationCategory.WarningSource, "Television", "Television", 3),
            new FloodMitigation(FloodMitigationIds.Radio, FloodMitigationCategory.WarningSource, "Radio", "Radio", 4),
            new FloodMitigation(FloodMitigationIds.SocialMediaInternet, FloodMitigationCategory.WarningSource, "Social Media/Internet", "Social Media/Internet", 5),
            new FloodMitigation(FloodMitigationIds.WardenVolunteerWarning, FloodMitigationCategory.WarningSource, "Flood Warden/Volunteer", "Flood Warden/Volunteer", 6),
            new FloodMitigation(FloodMitigationIds.NeighbourWarning, FloodMitigationCategory.WarningSource, "Neighbours", "Neighbours", 7),
            new FloodMitigation(FloodMitigationIds.OtherWarning, FloodMitigationCategory.WarningSource, "Other", "Other", 8),

            // Flood Warden Awareness
            new FloodMitigation(FloodMitigationIds.BeforeFlooding, FloodMitigationCategory.WardenAwareness, "Before flooding", "Before flooding", 1),
            new FloodMitigation(FloodMitigationIds.DuringFlooding, FloodMitigationCategory.WardenAwareness, "During flooding", "During flooding", 2),
            new FloodMitigation(FloodMitigationIds.AfterFlooding, FloodMitigationCategory.WardenAwareness, "After flooding", "After flooding", 3),
            new FloodMitigation(FloodMitigationIds.NotSureFloodWarden, FloodMitigationCategory.WardenAwareness, "What are flood wardens/volunteers?", "What are flood wardens/volunteers?", 4),

            // Import unknown - don't include in any forms but will be needed for displaying imported data with unknown values
            new FloodMitigation(new("019f6a3a-f7eb-7c43-97d8-2c7cfa9d79e3"), "All", "Unknown", "Imported record with unknown value", 99),
        ];
    }
