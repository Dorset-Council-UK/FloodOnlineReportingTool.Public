...
public interface ISubscribeRecordRepository
{
    ...
    /// </summary>
    /// <returns>A result pattern indicating success, or a list of errors.</returns>
    Task<DeleteResult<SubscribeRecord>> DeleteSubscriptionById(Guid subscriptionId, CancellationToken cancellationToken);


    /// <summary>
    /// Verifies a contact subscription record
    /// </summary>
    Task<bool> VerifySubscriptionRecord(Guid subscriptionId, int verificationCode, CancellationToken cancellationToken);
}
