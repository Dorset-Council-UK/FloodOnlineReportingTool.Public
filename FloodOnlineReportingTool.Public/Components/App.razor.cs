...
public partial class App(IOptions<GISOptions> _settings, GdsBlazorComponents.IGdsJsInterop gdsJs)
{
    [CascadingParameter]
    ...
    private readonly GISOptions _gisSettings = _settings.Value;
